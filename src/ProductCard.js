            ...
            {filteredProducts.length > 0 ? (
                filteredProducts.map((product) => (
                    <div key={product.id} className="col-md-4 col-lg-3">
                        <div
                            className="card h-100 border-0 shadow-sm p-3 rounded-4 product-card position-relative"
                            onClick={() => onSelect(product)}
                            style={{ cursor: 'pointer' }}
                        >
                            {/* Main Badge (New, Best Seller, etc.) */}
                            {product.badge && (
                            ...
                            {/* Free Shipping Badge - Nag-a-appear lang kung 500 pataas ang price */}
                            {product.price >= 500 && (
                                <span className="badge position-absolute top-0 end-0 m-3 rounded-pill px-2 py-1 shadow-sm"
                                    style={{ 
                                        backgroundColor: '#fff', 
                                        color: '#198754', 
                                        fontSize: '0.65rem', 
                            ...
                            {/* Shipping Note para sa mga items na may fee */}
                            <div className="mb-3" style={{ height: '15px' }}>
                                {product.price < 500 && (
                                    <p className="text-muted" style={{ fontSize: '0.6rem' }}>+ ₱45 Shipping Fee</p>
                                )}
                            </div>
