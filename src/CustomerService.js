                ...
                <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div className="card-body p-4">
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* FIX: IMAGE UPLOAD CONTAINER WITH POSITION RELATIVE */}
                            <div className="mb-4">
                                ...
                                <div className="position-relative" style={{ minHeight: '100px' }}>
                                    {image ? (
                                        ...
                                        <div className={`p-4 border-2 border-dashed rounded-4 text-center position-relative ${errors.image ? 'border-danger text-danger' : 'border-light-subtle text-muted'}`} style={{ backgroundColor: '#fafafa' }}>
                                            <i className="bi bi-camera fs-1"></i>
                                            <div className="mt-2 small">Click to upload photo</div>
                                            {/* Ang input na ito ay hindi na lalampas sa container na ito */}
                                            <input type="file" className="opacity-0 position-absolute w-100 h-100 top-0 start-0" accept="image/*" onChange={handleImageChange} style={{ cursor: 'pointer', zIndex: 1 }} />
                                        </div>
                                    )}
                                </div>
                            ...
                            {/* FIX: ACTION BUTTONS WITH Z-INDEX */}
                            <div className="d-flex gap-3 pt-2 position-relative" style={{ zIndex: 10 }}>
